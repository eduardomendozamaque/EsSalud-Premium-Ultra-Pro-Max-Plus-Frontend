...
export default function FarmaciaView({ userRole }) {
  ...
  return (
    <div>
      ...
      {(showAddModal || medicamentoToEdit) && (
        <MedicamentoModal 
              ...
              <div className="fv-detail-card">
                ...
                <div className="fv-detail-header">
                  <div className="fv-detail-header-left">
                    ...
                    <div className="fv-detail-badges" style={{ marginBottom: '8px' }}>
                    ...
                    {(userRole === 'Administrador' || userRole === 'Farmacéutico') && (
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                          ...
                          onClick={() => setMedicamentoToEdit(selected)}
                        >
                          <svg width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginRight: '4px' }}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                          Editar
                        </button>
                        <button
                          className="btn-secondary"
                          ...
                          onClick={async () => {
                            if (window.confirm('¿Estás seguro de eliminar este medicamento? Todo el stock asociado en todas las farmacias se eliminará permanentemente.')) {
                              try {
                                await api(`/medicamento/${selected.codigo}`, {
                                  method: 'DELETE',
                        ...
                        >
                          <svg width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginRight: '4px' }}><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                          Eliminar
                        </button>
                      </div>
                    )}
